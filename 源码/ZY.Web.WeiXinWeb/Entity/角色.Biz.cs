...
namespace XCode.Membership
{
    ...
    public partial class Role : Entity<Role>
    {
        ...
        public static IList<Role> Search(String name, String key, PageParameter page)
        {
        ...
        //static readonly FieldCache<Role> _CategoryCache = new FieldCache<Role>(__.Category)
        //{
