...
namespace XCode.Membership
{
    ...
    public partial class Menu : Entity<Menu>
    {
        ...
        /// <returns>实体列表</returns>
        public static IList<Menu> Search(String name, Int32 parentId, String key, PageParameter page)
        {
        ...
        //static readonly FieldCache<Menu> _CategoryCache = new FieldCache<Menu>(__.Category)
        //{
